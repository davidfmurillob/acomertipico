...
const Carousel = () => {
  ...
  const arrowStyle =
    'absolute text-white text-2xl z-10 h-10 w-10 flex items-center justify-center';
  ...
  const sliderControl = isLeft => (
    ...
    >
      <span role="img" aria-label={`Arrow ${isLeft ? 'left' : 'right'}`}>
        {isLeft ? <MdArrowBackIos/> : <MdArrowForwardIos/>}
      </span>
    </button>
  );
  ...
  // absolute positioning on each side of the image.
    <div className="p-12 md:flex justify-center w-full lg:w-1/2 items-center mx-auto">
      <div className="relative w-full max-w-lg lg:max-w-3xl mx-auto ">
