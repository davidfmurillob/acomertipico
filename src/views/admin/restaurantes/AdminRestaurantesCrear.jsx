...
const AdminRestaurantesCrear = () => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("nombre_establecimiento", establishment.name);
    formData.append("direccion_establecimiento", establishment.direction);
    formData.append("ubicacion", establishment.location);
    formData.append("descripcion", establishment.description);
    formData.append("telefono_establecimiento", establishment.telephone);
    formData.append("imagen", imageUrl);

    axios.post(`/api/establishment`, formData).then((res) => {
          ...
          <div className="mt-20 md:mt-10 mx-10 md:col-span-5 bg-slate-300 p-4 rounded-lg">
            <div className="px-4 sm:px-0 py-4">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Digita los campos correspondientes para crear el restaurante.
              </p>
            </div>
...
export default AdminRestaurantesCrear;
